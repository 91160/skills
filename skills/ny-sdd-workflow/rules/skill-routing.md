...
| -------------- | ------------------------------------- | ---------------------- | ----------------------- | ---- |
| PRD 审计       | §1.1 / §1.2(feature) / §2.6[prd]   | /prd-audit             | prd-audit               | 默认 |
...
| 前端规范提取   | §1.3 前后端规范提取                  | /front-project-context | front-project-context   | 默认 |
| 后端规范提取   | §1.3 前后端规范提取                  | /back-project-context  | back-project-context    | 默认 |
| 前端编码       | §3.5 代码变更（前端改动）            | /frontend-coding       | frontend-code-standards | 默认 |
| 后端编码       | §3.5 代码变更（后端改动）            | /java-coding           | java-coding             | 默认 |
| 代码审计       | §3.6 代码审计                        | /code-audit            | code-audit              | 默认 |
| 深度代码扫描   | §1.4 深度业务代码扫描                | /reverse-scan          | reverse-scan            | 默认 |
